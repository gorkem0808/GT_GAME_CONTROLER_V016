...
APP_TITLE = "GT GAME CONTROLER v023"
...
class App(tk.Tk):
    ...
    def create_ui(self):
        ...
        ttk.Label(header, text="v023  |  Tetik GP seçimi eklendi", style="Sub.TLabel").pack(side="left", padx=16)
    ...
    def verify_controller_config(self):
        ...
        if ok:
            ...
            messagebox.showwarning("Ayar kaydedilmedi",
                ...
                "Bu genelde Controller Pico'da eski UF2 yüklü demektir. Yeni V020 controller.uf2 derlenip yüklenmeli.")
