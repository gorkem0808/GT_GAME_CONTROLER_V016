# GT GAME CONTROLER V015 - Temiz Kaynak Paket
...
4. `Build GT GAME CONTROLER V015 UF2` işini çalıştır.
5. Yeşil tik bitince Artifacts kısmından `GT_GAME_CONTROLER_3PICO_v015_UF2_READY` dosyasını indir.
...
2. Not Defteri aç.
3. GP6 → GND = 5 yazmalı.
4. GT_GAME_CONTROLER_v015.bat çalıştır.
